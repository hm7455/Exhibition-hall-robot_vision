...
parser.add_argument("--input_image", type=str, default="259.jpg",
...
size = (1920,1080)
video_writer = cv2.VideoWriter(r'outputVideo.mp4',cv2.VideoWriter_fourcc('m', 'p', '4', 'v'), 30, size)
...
with tf.Session() as sess:
    ...
    while cap.isOpened():
        ...
        objecr_x1, objecr_y1, objecr_x2, objecr_y2 = boxes_[position][0], boxes_[position][1], boxes_[position][2], \
                                                     boxes_[position][3]
