...
# some paths
parser.add_argument("--eval_file", type=str, default="./data/my_data/train.txt",
                    help="The path of the validation or test txt file.")

parser.add_argument("--restore_path", type=str, default="./checkpoint/model-epoch_990_step_91171_loss_0.1478_lr_1e-05",
